...
//    private ArrayList<ParkingSlots> parkingSlots;
    ...
    public CameraIdModel() {

    }

    public CameraIdModel(String cameraLat, String cameraLong, String parkingType, String securityRatings, HashMap<String,Object> parkingRules, String cameraLocationName, String videoUrl, String roadWidth,
                  String cameraFacingDirection, String listofcarsPosition, String listofObstacles, String cameraImageUrl, String cameraID,HashMap<String,Object> parkingSlots) {
