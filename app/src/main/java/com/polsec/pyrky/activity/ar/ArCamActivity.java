...
//        arFragmentSupport.setWorld(world);
    ...
    private void Directions_call(){
        ...
        RetrofitInterface apiService =
         ...
         Call<Example> call = apiService.getDirections(srcLatLng, destLatLng,
...
//                        .getDuration().getText());
    ...
    protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(ArCamActivity.this, mSensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION),
